...
| 46 | `(无)` | `'EC' \|\| SUBSTRING(D.PENSION_INDUSTRY, 1, 2)` |
| 47 | `(无)` | `CASE WHEN NOT F.LOAN_NUM IS NULL THEN '1' ELSE '0' END` |
| 48 | `(无)` | `CASE WHEN T.ACCT_TYP LIKE '01%' OR C.CUST_TYP = '3' THEN 'C02' WHEN SUBSTRING(T.ITEM_CD, 1, 4) IN ('1303', '1305', '1306') THEN 'C01' WHEN SUBSTRING(T.ITEM_CD, 1, 6) IN ('130101', '130104') THEN 'C03'...` |
