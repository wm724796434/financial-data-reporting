...
| 46 | `(无)` | `CASE WHEN T.ACCT_TYP LIKE '01%' OR C.CUST_TYP = '3' THEN 'C02' WHEN SUBSTRING(T.ITEM_CD, 1, 4) IN ('1303', '1305', '1306') THEN 'C01' WHEN SUBSTRING(t.ITEM_CD, 1, 6) IN ('130101', '130104') THEN 'C03'...` |
| 47 | `GREEN_LOAN_RATIO` | `T.GREEN_CREDIT_RATIO AS GREEN_LOAN_RATIO` |
| 48 | `NBJGH` | `T.ORG_NUM AS NBJGH` |
| 49 | `FRNBJGH` | `CASE WHEN T.ORG_NUM LIKE '51%' THEN '510000' WHEN T.ORG_NUM LIKE '52%' THEN '520000' WHEN T.ORG_NUM LIKE '53%' THEN '530000' WHEN T.ORG_NUM LIKE '54%' THEN '540000' WHEN T.ORG_NUM LIKE '55%' THEN '550...` |
| 50 | `(无)` | `T.CUST_ID` |
| 51 | `(无)` | `A2.CUST_NAM` |
| 52 | `(无)` | `T.LOAN_ACCT_BAL` |
| 53 | `(无)` | `T.CURR_CD` |
| 54 | `(无)` | `T.LOAN_ACCT_BAL * U.CCY_RATE` |
| 55 | `(无)` | `T.DRAWDOWN_AMT` |
| 56 | `(无)` | `T.DISCOUNT_INTEREST` |
| 57 | `FIELD_TYPE` | `'T99' AS FIELD_TYPE` |
| 58 | `GREEN_LOAN_TYPE` | `CASE WHEN A2.INLANDORRSHORE_FLG = 'N' AND NOT T.GREEN_CREDIT_USAGE IS NULL THEN 'W00' WHEN SUBSTRING(T.GREEN_CREDIT_USAGE, 1, 1) = '1' THEN 'NA01' WHEN SUBSTRING(T.GREEN_CREDIT_USAGE, 1, 1) = '2' THEN...` |
