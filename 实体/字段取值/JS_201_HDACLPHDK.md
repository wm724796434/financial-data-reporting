# JS_201_HDACLPHDK — 字段取值

> 来源程序: `bsp_sp_js_201_hdaclphdk.prc`
...
| 52 | `(无)` | `CASE WHEN NOT XW.LOAN_NUM IS NULL THEN '1' ELSE '0' END` |
| 53 | `(无)` | `CASE WHEN NOT GTJY.LOAN_NUM IS NULL THEN '1' ELSE '0' END` |
| 54 | `(无)` | `CASE WHEN NOT XWJY.LOAN_NUM IS NULL THEN '1' ELSE '0' END` |
| 55 | `(无)` | `CASE WHEN NOT NHJY.LOAN_NUM IS NULL THEN '1' ELSE '0' END` |
| 56 | `(无)` | `CASE WHEN NOT CYDB.LOAN_NUM IS NULL THEN '1' ELSE '0' END` |
| 57 | `(无)` | `'0'` |
| 58 | `POVERTY_LOAN_FLG` | `NULL AS POVERTY_LOAN_FLG` |
| 59 | `(无)` | `CASE WHEN T.ACCT_TYP LIKE '01%' OR C1.CUST_TYP = '3' THEN 'C02' WHEN SUBSTRING(T.ITEM_CD, 1, 4) IN ('1303', '1305', '1306') AND NOT GTJY.LOAN_NUM IS NULL THEN 'C02' WHEN SUBSTRING(T.ITEM_CD, 1, 4) IN ...` |
| 60 | `NBJGH` | `T.ORG_NUM AS NBJGH` |
...
| 62 | `(无)` | `A2.CUST_NAM` |
| 63 | `(无)` | `T.LOAN_ACCT_BAL` |
| 64 | `(无)` | `T.CURR_CD` |
| 65 | `(无)` | `T.LOAN_ACCT_BAL * U.CCY_RATE` |
| 66 | `(无)` | `T.DRAWDOWN_AMT` |
| 67 | `(无)` | `T.DISCOUNT_INTEREST` |
| 68 | `FIELD_TYPE` | `'T99' AS FIELD_TYPE` |
